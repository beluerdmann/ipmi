...
void grilla (int cant, int tam, color colorN) {
...
void cruz(int cant, int tam, int tamCir, color colorN) {
...
void cuadrante1(int cant, int tam, int tamCir, color colorN) {
  for (int i=0; i<cant; i++) {
    for (int j=0; j<cant; j++) {
      if ((i+j)%2==0) {
        fill(255);
...
void cuadrante2(int cant, int tam, int tamCir, color colorN) {
  for (int i=0; i<cant; i++) {
    for (int j=0; j<cant; j++) {
      if ((i+j)%2==0) {
        fill(colorN);
